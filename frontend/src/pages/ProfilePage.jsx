...
export default function ProfilePage() {
  ...
  if (!user) {
    return (
      <p className="rounded-lg bg-white p-6 text-center dark:bg-slate-900">
        Loading profile...
      </p>
    );
  }
  ...
  return (
    <div className="mx-auto w-full max-w-6xl overflow-hidden rounded-lg border border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900">
        ...
        <div className="mt-6 grid gap-5 md:grid-cols-[1fr_2fr]">
          ...
          <section className="rounded-lg bg-slate-50 p-4 dark:bg-slate-950">
            ...
            <p className="mt-3 text-sm text-slate-500">
              User-specific posts will appear here in the next phase.
            </p>
          </section>
        </div>
      </div>
